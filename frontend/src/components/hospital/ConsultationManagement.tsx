...
interface Consultation {
  ...
  heure: string
  type: string
  statut: 'programmee' | 'en-cours' | 'terminee' | 'annulee'
  hopital: string
  motif?: string
  diagnostic?: string
}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full">
              {consultations.filter(c => c.statut === 'programmee').length} programmées
            </span>
          </div>
        </div>
                ...
                <tr key={consultation.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500 font-mono">{consultation.patientId}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">{consultation.heure}</div>
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(consultation.statut)}`}>
                      ...
                      <span className="ml-1">{getStatusLabel(consultation.statut)}</span>
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
